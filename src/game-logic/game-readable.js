...
Game.prototype.changeSkin = function (_0x5e6258) {
  ...
  if (
    _0x5e6258 >= 1000 ||
    (undefined !== this.skins[_0x5e6258] &&
  ...
  var _0x3db09a =
    _0x5e6258 >= 1000 ||
    undefined === this.skins[_0x5e6258].cdn ||
  ...
  } else if (0 === _0x5e6258 && "webGL" === this.v.NAME) {
...
Game.prototype.loadSounds = function (_0x9a7ba1, _0x1749ee) {
  ...
  var _0x47b3b9 = function (_0xe86db5, _0x3272d2) {
      ...
      if (!_0x1c90d9 || !createjs.Sound._idHash[_0xe86db5]) {
        return void console.error(
          "loadSounds error: src parse / cannot init plugins, id=" +
            _0xe86db5 +
            (false === _0x1c90d9 ? ", rs=false" : ", no _idHash"),
        );
      }
...
Game.prototype.unloadSounds = function (_0x52fdc5, _0x5b0fd8) {
  if ("undefined" != typeof createjs && createjs.Sound && _0x52fdc5) {
    if (null == _0x5b0fd8) {
      _0x5b0fd8 = "";
    }
    var _0x464c60 = [
    ...
    if (_0x52fdc5.spawns && "object" == typeof _0x52fdc5.spawns) {
    ...
    if (_0x52fdc5.comboTones && Array.isArray(_0x52fdc5.comboTones)) {
      ...
      "object" == typeof _0x52fdc5.comboTones &&
...
Game.prototype.drawBgGrid = function (_0x37d3dd) {
  _0x37d3dd = undefined === _0x37d3dd ? 1 : _0x37d3dd;
  ...
  if (1 === _0x37d3dd) {
    ...
    for (_0x1fcdcc = 0; _0x1fcdcc < 9; _0x1fcdcc++) {
      for (var _0xa9127f = 1; _0xa9127f < 20; _0xa9127f++) {
        this.bgctx.moveTo(
          _0x1fcdcc * this.block_size + 0.75 * this.block_size,
          _0xa9127f * this.block_size + 0.5,
        );
        this.bgctx.lineTo(
          (_0x1fcdcc + 1) * this.block_size + 0.2 * this.block_size,
          _0xa9127f * this.block_size + 0.5,
        );
      }
    }
...
Game.prototype.startPractice = function (
  ...
  if (
    ...
    if (1 === this.pmode) {
      ...
      showElem(this.sprintInfo);
    } else if (4 === this.pmode) {
      this.sprintMode = 1;
      this.Replay.config.m = 262144 | this.sprintMode;
      this.linesRemaining = 9999999999;
      this.setLrem(9999999999);
      hideElem(this.sprintInfo);
    } else if (5 === this.pmode) {
      this.sprintMode = 1;
      ...
      if (6 === this.pmode) {
        ...
        return void this.MapManager.prepare(_0x32a922.mapId);
      }
      if (7 === this.pmode) {
        this.sprintMode = 1;
        ...
        return void (this.starting = true);
      }
    }
    _0xd2a592.call(this);
  }
...
Game.prototype.readyGo = function () {
  ...
  if (!this.pmode) {
    ...
    hideElem(this.Live.teamOptions);
    if (2 === this.Live.liveMode) {
      hideElem(this.sprintInfo);
      hideElem(this.practiceMenu);
      hideElem(this.botMenu);
      showElem(this.teamInfo);
      showElem(this.rInfoBox);
    } else if (3 === this.Live.liveMode) {
      ...
      if (6 === this.pmode) {
        ...
        this.sprintMode =
          null != this.Live.liveModeId ? this.Live.liveModeId : 1;
      }
      var _0x8f459c = {
        callback: function () {
          ...
          if (
            !(
              (6 === this.livePmode &&
                this.MapManager.mapData.queue) ||
              (9 === this.livePmode && this.ModeManager.noQueueRefill)
            )
          ) {
            this.generateLiveQueue();
            this.updateQueueBox();
          }
          if (9 === this.livePmode && this.Live.umLoadingPhase) {
            this.Caption.mapLoading(2);
            return void this.Live.sendUsermodeReady();
          }
          this.startReadyGo();
        }.bind(this),
        isLivePmode: true,
      ...
      return void this.startPractice(this.pmode, false, _0x8f459c);
    }
  }
  this.startReadyGo();
};
  ...
  if (_0x47e939) {
    if (_0x1b65a5) {
      ...
      for (
        ...
        if (
          -1 !==
          this.Live.notPlaying.indexOf(this.Live.players[_0x147dce])
        ) {
          _0x140a75 += 1;
        }
      }
...
Game.prototype.restart = function () {
  if (this.starting && (this.Live.LiveGameRunning || this.pmode)) {
    ...
    if (!this.isPmode(true)) {
      ...
      if (2 !== this.Live.liveMode && 3 !== this.Live.liveMode) {
        hideElem(this.rInfoBox);
      }
      this.Live.toggleMorePractice(true, false);
      if (1 === this.R.ext) {
    ...
    if (this.isPmode(false)) {
      ...
      } else if (4 === this.isPmode(false)) {
        this.lastGarbage = 0;
      }
    }
    if (1 === this.Live.liveMode && !this.isPmode(true)) {
      for (
        var _0x5a96a9 = 0;
...
Game.prototype.keyInput2 = function (_0x2d7914) {
  if (
    ...
    if (9 === _0x2d7914.keyCode) {
      _0x2d7914.preventDefault();
      return void this.Bots.cycleBotPlacementOutlineMode();
    }
    if (27 === _0x2d7914.keyCode) {
      _0x2d7914.preventDefault();
      return void this.Bots.room.forfeitRound();
    }
  }
  if (
    113 !== _0x2d7914.keyCode &&
    (_0x2d7914.keyCode !== this.Settings.controls[9] ||
      (9 === this.isPmode(false) &&
  ...
  if (
    !(
      0 !== this.focusState ||
      (38 !== _0x2d7914.keyCode &&
        40 !== _0x2d7914.keyCode &&
        32 !== _0x2d7914.keyCode)
    )
  ) {
    _0x2d7914.preventDefault();
  }
  if (
    ...
    if (_0x2d7914.repeat) {
      return void _0x2d7914.preventDefault();
    }
    if (9 === this.isPmode(false)) {
    ...
    if (this.starting) {
      return void (_0x2d7914.keyCode === this.Settings.ml
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            !(_0x2d7914.keyCode !== this.Settings.sd || this.softDrop)
          ) {
...
Game.prototype.directionCancel = function (_0x3aac2f, _0x3ec063) {
  ...
  if (1 === this.DASmethod && false === _0x3ec063) {
    var _0x4d4f92 = -1 === _0x3aac2f ? 1 : -1;
...
Game.prototype.evalDefferedDAS = function (_0x31bdef, _0x3be102) {
  if (null === _0x31bdef) {
    ...
    if (
      this.pressedDir[1] &&
      (null === _0x31bdef || this.pressedDir[1] < this.pressedDir[-1])
    ) {
      _0x31bdef = 1;
    }
    if (null === _0x31bdef) {
...
Game.prototype.setDASto = function (_0x1ab33e, _0x479f06, _0x4c1969) {
  var _0x4e1449 = null === _0x4c1969 ? this.getDAS() : _0x4c1969;
  if (_0x479f06 || null === this.DASto[_0x1ab33e]) {
    if (_0x479f06 && null === this.DASto[_0x1ab33e]) {
      var _0x51224e = this;
      this.DASto[_0x1ab33e] = window.setTimeout(function () {
        _0x51224e.DASto[_0x1ab33e] = null;
        var _0x2a466d = -1 === _0x1ab33e ? 1 : -1;
        if (
          _0x51224e.lastDAS !== _0x1ab33e &&
          (_0x51224e.play || null !== _0x51224e.animator)
        ) {
          var _0x36300b = _0x51224e.timestamp();
          if (
            !(
              -1 === _0x51224e.pressedDir[_0x1ab33e] ||
            ...
            if (_0x51224e.DASdebug && null === _0x4c1969) {
...
Game.prototype.hasGhost = function () {
  return undefined === this.R.ghost || -1 === this.R.ghost
    ? this.ghostEnabled
    : 1 === this.R.ghost;
};
Game.prototype.getDAS = function () {
  return undefined === this.R.DAS || -1 === this.R.DAS
    ? this.Settings.DAS
    : this.R.DAS;
};
Game.prototype.getARR = function () {
  return undefined === this.R.ARR || -1 === this.R.ARR
    ? this.Settings.ARR
    : this.R.ARR;
};
...
Game.prototype.updateLiveMatrix = function (
  ...
  if (
    !(
      ...
      null !== this.Live.clients[_0x59e37f].rep
    )
  ) {
...
Game.prototype.playSound = function (_0x16de67, _0x4c6855) {
  if (this.SEenabled && this.R.sfx) {
    ...
    var _0x423417 = this;
    var _0x4d0ca0 = false;
    var _0x5b7f0b = function (_0x2fb25b, _0x561b58) {
    ...
    if (Array.isArray(_0x16de67)) {
      ...
      if (1 !== _0x4c6855 && this.VSEenabled && this.R.vsfx) {
...
function OneBlock(_0x1360a8, _0x167ca9, _0x402185, _0x377295) {
  ...
  if (_0x377295) {
    ...
    for (let _0x2c4408 = 0; _0x2c4408 < _0x402185; _0x2c4408++) {
      ...
      } while (-1 !== this.bag.indexOf(_0x49d0cc));
...
function soundCredits(_0x6b6cf0) {
  ...
  var _0x5d0e4e;
  var _0x1116ab;
  if ("sfxSelect" == _0x6b6cf0.srcElement.id) {
    _0x38b98b = "soundDesc";
    _0x5d0e4e = "audioCred";
    _0x1116ab = SFXsets;
  } else {
    ...
    for (var _0x203750 = 0; _0x203750 < _0x28c4ba; _0x203750++) {
      for (var _0x33a630 = 0; _0x33a630 < 4; _0x33a630++) {
        _0x56e18f += String.fromCharCode(
          _0xcb1318[4 * _0x203750 + 3 - _0x33a630],
        );
      }
    }
  } else {
...
Game.prototype.beforeHardDrop = function (_0x42d743) {
  if (this.botPlacement) {
    ...
    if (
      ...
      return void this._rejectTblPlacement(_0x42d743);
    }
    if (
...
Game.prototype.hardDrop = function (_0xe14579) {
  ...
  if (this.hdAbort) {
    return void (this.hdAbort = false);
  }
  ...
  if (
    ...
    this.lockDelayActive = false;
    return void (this.lastGeneration = _0xe14579);
  }
  ...
  if (!this.gameEnded || this.play) {
    ...
    if (this.isPmode(false)) {
      if (!(1 === this.isPmode(false))) {
        ...
        } else if (7 === this.isPmode(true)) {
          this.practiceModeCompleted();
        } else if (9 === this.isPmode(true)) {
...
Game.prototype.getAdjustedLiveSeed = function (_0x3d1359) {
  ...
  do {
    _0x3d1359 =
      _0x4bfb51 + (0 === _0x594684 ? "" : _0x594684.toString(36));
...
Game.prototype.isBannedStartSequence = function (
  ...
  return (
    _0x68108b.length >= 2 &&
    _0x265839 <= 3 &&
    (!_0x45fe85 || 0 === this.conf[0].rnd) &&
    ((1 === _0x2cf643 &&
      (_0x68108b[0].id >= 5 ||
        (1 === _0x68108b[0].id && _0x68108b[1].id >= 5))) ||
      (2 !== _0x2cf643 &&
        _0x68108b[0].id >= 5 &&
        _0x68108b[1].id >= 5))
  );
...
Game.prototype.refillQueue = function () {
  if (
    !(
      (6 === this.isPmode(false) &&
        null != this.MapManager.mapData.queue) ||
      (9 === this.isPmode(false) && this.ModeManager.noQueueRefill)
    )
  ) {
...
Game.prototype.practiceModeCompleted = function (_0x1c7fd3) {
  ...
  if (2 !== this.isPmode(true)) {
    if (this.livePmode) {
      if (this.Bots && 1 == this.Bots.mode) {
    ...
    } else if (this.pmode && 9 !== this.pmode) {
      this.Live.sendGameModeResult(this.Replay);
    }
  }
};
...
Game.prototype.update = function (_0x34c044, _0x54c51d) {
  ...
  if (this.play) {
    ...
    if (this.lockDelayActive) {
      if (_0x54c51d - this.lastAction >= this.lockDelay) {
        if (
          ...
          this.pmode ||
          (null === this.solidInterval && !this.solidToAdd)
        ) {
          this.lockDelayActive = false;
        }
      }
    ...
    if (7 == (7 & this.frames) || this.GameStats.dirty) {
      this.updateTextBar();
    }
    if (31 == (31 & this.frames)) {
...
Game.prototype.getCumulativePPS = function () {
  ...
  return isNaN(_0xf525d) || !isFinite(_0xf525d) ? 0 : _0xf525d;
};
...
Game.prototype.sendRepFragment = function () {
  if (1 === this.transmitMode) {
    ...
    for (
      ...
      _0x201a0b.t =
        null === _0x4373b4 ? 0 : Math.max(0, _0x4efefd.t - _0x4373b4);
...
Game.prototype.addIntoGarbageQueue = function (_0xc31d0b) {
  ...
  if (0 === this.R.mess) {
    ...
    for (
      ...
      _0x15730d++;
      if (100 === _0x2adaae || Math.random() < _0x2adaae / 100) {
...
Game.prototype.addAsyncGarbage = function (_0x1c994a) {
  ...
  this.updateGhostPiece(true);
  if (4 === this.isPmode(false) && -4 === this.activeBlock.pos.y) {
    this.GameOver();
  }
  return _0x1133bb;
};
...
Game.prototype.solidStartRaising = function () {
  ...
  this.cancelSolid();
  var _0x24de41 = function () {
    let _0x280a4c =
      1000 * _0x4e3455[Math.min(_0x4e3455.length - 1, _0x59d561)];
    _0x55536c.solidInterval = setTimeout(_0x5d89b0, _0x280a4c);
  };
  var _0x5d89b0 = function () {
...
Game.prototype.browserTabFocusChange = function (_0x42f107) {
  if (0 === _0x42f107) {
    ...
    this.isTabFocused = true;
    const _0x2464ea =
      9 === this.isPmode(false) && this.ModeManager.startingTimeout;
    if (
      !(
        null === this.lastSeen ||
        this.play ||
      ...
      if (_0xaab6a0 > 1000) {
        this.Replay.config.afk =
          undefined === this.Replay.config.afk
            ? _0xaab6a0
...
Game.prototype.evalPCmodeEnd = function () {
  ...
  if (!_0x3597f4) {
    ...
    for (var _0x1ed215 = 0; _0x1ed215 < 10; _0x1ed215++) {
      if (0 !== this.matrix[_0x90c57a][_0x1ed215]) {
        _0x3597f4 = true;
        break;
      }
    }
...
Game.prototype.getCurrentPPS = function () {
  ...
  return isNaN(_0x1be41c) || !isFinite(_0x1be41c) ? 0 : _0x1be41c;
};
...
Game.prototype.setupGameLinks = function () {
  ...
  let _0xc4b43a = function (_0x246684, _0x1a3841, _0x208600) {
    ...
    if ("The Private Room" == _0x2c6962.roomName) {
...
LineClearAnimator.prototype.render = function (_0x25b550) {
  ...
  for (var _0x43dbca = 0; _0x43dbca < 20; _0x43dbca++) {
    if (-1 !== this.clearPositions.indexOf(_0x43dbca)) {
      if (this.IS_SOLID) {
    ...
    for (var _0x87287c = 0; _0x87287c < 20; _0x87287c++) {
      for (var _0x2770c4 = 0; _0x2770c4 < 10; _0x2770c4++) {
        this.drawBlock(
          _0x2770c4,
          _0x87287c,
          15 & this.g.matrix[_0x87287c][_0x2770c4],
        );
        if (16 & this.g.matrix[_0x87287c][_0x2770c4]) {
...
WebGLView.prototype.initRenderer = function () {
  ...
  if (undefined !== this.g.skinId && this.g.skinId) {
...
WebGLView.prototype.initEmptyTexture = function (
  ...
  var _0x3ca98a = new Uint8Array(4 * _0x4b79ad);
  for (var _0x1e5941 = 0; _0x1e5941 < _0x4b79ad; ++_0x1e5941) {
    ...
    _0x3ca98a[4 * _0x1e5941] = Math.round(255 * _0x23c5cd[0]);
    _0x3ca98a[4 * _0x1e5941 + 1] = Math.round(255 * _0x23c5cd[1]);
    _0x3ca98a[4 * _0x1e5941 + 2] = Math.round(255 * _0x23c5cd[2]);
    _0x3ca98a[4 * _0x1e5941 + 3] = 255;
  }
...
WebGLView.prototype.realSetupGif = function (_0x12ce5a) {
  ...
  if (this.video && "canvas" === this.video.tagName) {
    ...
    for (var _0x1a6b27 = 0; _0x1a6b27 < 9; ++_0x1a6b27) {
      ...
      if (this.videoOpts.colorize) {
        ...
        _0x31e03d.fillStyle =
          ...
          _0x3ed6af +
          ")";
        _0x31e03d.fillRect(64 * _0x1a6b27, 0, 64, 64);
      }
    }
  } else {
    _0x31e03d.drawImage(
...
WebGLView.prototype.setupVideo = function (_0x827a28, _0xbc7a41) {
  ...
  _0x5dc5d0.muted = true !== this.videoOpts.sound;
...
FastFont.prototype.drawText = function (_0x59f92d, _0x43030e) {
  ...
  var _0x575ea9 = _0x499faa + 2 * _0x5cb111;
  var _0x3de434 = _0x499faa + 2 * _0x5cb111;
  ...
  for (var _0x4baf76 = 0; _0x4baf76 < _0x59f92d.length; _0x4baf76++) {
    ...
    this.verElem.set(
      [
        0x0 + (0 - _0x5cb111) * _0x5d9447,
        _0x742cea.y - _0x1b58d0 * _0x5d9447,
        0x0 + (0 - _0x5cb111 + _0x575ea9) * _0x5d9447,
        _0x742cea.y - _0x1b58d0 * _0x5d9447,
        0x0 + (0 - _0x5cb111) * _0x5d9447,
    ...
    _0x36a6a6 += 12;
    _0x742cea.x = 0x0 + _0x4d480c * _0x5d9447;
  }
...
GameCore.prototype.getRandomizerBlock = function (_0x280441) {
  ...
  } else if (-1 === _0x580db9.set) {
    _0x580db9.set = 0;
  }
  if (null !== this.temporaryBlockSet) {
...
GameCore.prototype.checkIntersection = function (
  ...
  _0x13f8b8 = null === _0x13f8b8 ? this.activeBlock.rot : _0x13f8b8;
...
GameCore.prototype.centerColumnCheck = function (
  ...
  return (
    !(_0x2960e2 < 0) &&
    (3 === _0x2dede5 || 4 === _0x2dede5
      ? 0 === this.activeBlock.rot
        ? (_0xa72dd6 =
            ...
            !(
              ...
              this.matrix[_0x2960e2][
                _0x3d6170 + ((2 * (4 === _0x2dede5)) | 0)
              ] > 0
            ))
        : 3 === this.activeBlock.rot &&
          (_0xa72dd6 =
            this.matrix[_0x2960e2][_0x3d6170 + 1] > 0 ||
            this.matrix[_0x2960e2 + 1][_0x3d6170 + 1] > 0)
      : 2 === _0x2dede5 &&
        ((0 !== this.activeBlock.rot && 2 !== this.activeBlock.rot) ||
  ...
  if (
    ...
    for (let _0x13e68f = 0; _0x13e68f < _0x3478f0; _0x13e68f++) {
      ...
      if (
        ...
        if (2 === _0x23bb0f.id) {
          this.tspinType = 10 * _0x3bc6c3 + _0x13e68f;
        } else if (50 === _0x23bb0f.id) {
          if (2 === _0x1f4bf2) {
            return;
          }
          if (3 === _0x3bc6c3 && _0x13e68f < 14) {
            return;
          }
          if (
            ((1 === _0x3bc6c3 && 0 === this.activeBlock.rot) ||
              (2 === _0x3bc6c3 && 1 === this.activeBlock.rot)) &&
            3 !== _0x13e68f
          ) {
            return;
          }
          if (
            ((0 === _0x3bc6c3 && 1 === this.activeBlock.rot) ||
              (1 === _0x3bc6c3 && 2 === this.activeBlock.rot)) &&
            11 !== _0x13e68f
          ) {
            return;
          }
          if (3 === this.activeBlock.rot && 0 !== _0x3bc6c3) {
            return;
          }
        }
...
GameCore.prototype.gravityStep = function (_0xda41ff, _0x1cba96) {
  return this.checkIntersection(
    ...
    : (this.activeBlock.pos.y++,
      (this.lockDelayActive = false),
      (this.spinPossible = false),
      _0xda41ff ? 1 + this.gravityStep(_0xda41ff - 1, _0x1cba96) : 1);
};
GameCore.prototype.holdBlock = function () {
  if (!this.holdUsedAlready && this.R.holdEnabled) {
    ...
    if (this.ISGAME) {
      if (this.ModeManager && 9 === this.isPmode(false)) {
...
GameCore.prototype.checkTSpin = function (_0x56f0f2) {
  ...
  this.spinPossible = 2 === _0x13b95e && _0x4db81d >= 1;
  this.spinMiniPossible = 1 === _0x13b95e && 2 === _0x4db81d;
};
    ...
    if (_0x23e2a5 > 0) {
      ...
      switch (_0x23e2a5) {
        ...
        case 3:
          ...
          if (
            ...
            (2 !== _0x105f70.id && 50 !== _0x105f70.id)
          ) {
            this.isBack2Back = false;
      ...
      if (this.R.allSpin && this.spinPossible) {
        if (
          ...
          -1 !== this.excludedBlocksAS.indexOf(_0x105f70.name)
        ) {
          _0x44c711 = 0;
          if (this.debug) {
            _0x31022d = "Ignored " + _0x105f70.name + "-Spin";
          }
        } else if (2 !== _0x105f70.id) {
          if (1 === this.R.allSpin) {
            _0x55b2e1 = this.Scoring.A.TSPIN_TRIPLE;
            if (_0x23e2a5 >= 4) {
      ...
      if (
        ...
        this.MapManager.mapData.finish ===
          this.MapManager.FINISH_STANDARD &&
        0 === this.MapManager.mapLines.length
      ) {
        this.practiceModeCompleted(_0x45abcd);
      }
      this.fourWideFlag =
      ...
      if (this.isPmode(false)) {
        ...
        if (1 === this.isPmode(false)) {
          ...
          if (20 === this.gamedata.TSD) {
            this.gamedata.TSD20 = Math.round(1000 * this.clock);
          }
        } else if (this.ISGAME && 8 === this.isPmode(false)) {
        ...
        } else if (this.ISGAME && 9 === this.isPmode(false)) {
          ...
          if (9 === this.livePmode && (_0x24a663 || _0x587c77)) {
...
GameCore.prototype.countGarbageHeight = function (_0x593ea6) {
  ...
  for (var _0x102140 = 0; _0x102140 < _0x593ea6; _0x102140++) {
    if (
      8 !== this.matrix[19 - _0x102140][0] &&
      8 !== this.matrix[19 - _0x102140][1]
    ) {
      _0x24a3b6 = _0x102140;
      break;
    }
...
GameCore.prototype.is4W = function (_0x1651bc) {
  ...
  for (var _0x58ddcd = _0x1651bc; _0x58ddcd >= 0; _0x58ddcd--) {
    ...
    for (var _0x145124 = 0; _0x145124 < 10; _0x145124++) {
      if (9 !== this.matrix[_0x58ddcd][_0x145124]) {
        if (0 === this.matrix[_0x58ddcd][_0x145124]) {
          if (_0x1c10c7) {
            _0x123030 = -1;
            _0x1c10c7 = false;
            break;
      ...
      if (_0x3338c6 > 0) {
        ...
        if (_0x49dd79 + _0x4e6756 >= 0 && _0x4bcc0 + _0x2de1ed >= 0) {
          ...
          if (
            ...
            0 === this.deadline[_0x4bcc0 + _0x2de1ed]
          ) {
...
GameCore.prototype.addGarbageFromQueue = function (_0x4d5f11) {
  if (this.redBar > 0) {
    ...
    this.redBar = 0;
    for (
      null === _0x3dee1e && this.recordRedbarChange(_0x4d5f11);
      _0x596dd4 < _0x39f1ed;
    ) {
...
GameCore.prototype.addGarbage = function (_0x3abaca) {
  ...
  if (this.R.solidAttack) {
    ...
    if (9 === _0x106bff && this.garbageCols.length) {
      _0x5118a6 = this.garbageCols.shift();
    } else if (3 !== _0x106bff && 4 !== _0x106bff) {
      if (this.R.mess >= 0) {
    ...
    if (this.R.gInv) {
      for (
        ...
        _0x5a328e[_0x3c656a] = 8 === _0x5a328e[_0x3c656a] ? 0 : 8;
      }
    }
...
GameCore.prototype.addToGarbageQueue = function (_0x467a7d) {
  ...
  if (0 === this.R.mess) {
    ...
    for (
      ...
      _0x3afedc++;
      if (100 === _0x213998 || Math.random() < _0x213998 / 100) {
...
GameCore.prototype.getAPM = function () {
  ...
  var _0x504a59 =
    Math.round((100 * this.gamedata.attack) / (_0x2c1438 / 60)) / 100;
  return isNaN(_0x504a59) || !isFinite(_0x504a59) ? 0 : _0x504a59;
};
GameCore.prototype.getKPP = function () {
  ...
  return Math.round(100 * _0x5d032f) / 100;
};
...
GameCore.prototype.getComboAttack = function (_0x3102d5) {
  return _0x3102d5 <= 12
    ? this.comboAttack[_0x3102d5]
    : this.comboAttack[this.comboAttack.length - 1];
};
...
GameCore.prototype.blockOrSendAttack = function (
  ...
  return _0x59d750 > 0 &&
    (0 === this.Live.liveMode ||
      2 === this.Live.liveMode ||
      9 === this.livePmode)
    ? _0x59d750
    : null;
};
...
GameCore.prototype.resetGameData = function () {
  ...
  for (let _0x50079d of _0x53ebee) this.gamedata[_0x50079d] = 0;
};
...
GameCore.prototype.getGravityLevel = function (_0x5a5fc0) {
  return _0x5a5fc0 <= 0
    ...
    : _0x5a5fc0 <= 18
      ? [(18 - 1 * (_0x5a5fc0 - 1)) / 20, 0]
      : _0x5a5fc0 <= 24
        ? [(0.9 - 0.1 * (_0x5a5fc0 - 19)) / 20, 0]
        : 25 === _0x5a5fc0
          ? [0.03, 1]
          : 26 === _0x5a5fc0
            ? [0.02, 1]
...
BsBlock.prototype.getBlock = function () {
  ...
  if (this.i >= 21 && this.randomizer.RNG() < 0.1) {
    ...
    this.i = 0;
    if (2 === _0x44310d.set) {
      _0x44310d.id = Math.floor(7 * this.randomizer.RNG());
    }
    if (4 === _0x44310d.set) {
      _0x44310d.id = Math.floor(18 * this.randomizer.RNG());
    }
  }
  return _0x44310d;
};
BigBlockRand.prototype.getBlock = function () {
  ...
  if (this.randomizer.RNG() < this.i / this.EXPECTED_BLOCKS) {
    _0x208771.set = 2;
    _0x208771.id = Math.floor(7 * this.randomizer.RNG());
  }
  return _0x208771;
};
ConstBlock.prototype.getBlock = function () {
  let _0x44f012 = new Block(this.id);
  _0x44f012.set = 0 === this.set ? -1 : this.set;
  return _0x44f012;
};
...
Live.prototype.saveRD = function () {
  ...
  for (_0x16c249 = 0; _0x16c249 < _0x284c45.length; ++_0x16c249) {
    if (
      "attackMode" !== _0x284c45[_0x16c249].id &&
      "radio" !== _0x284c45[_0x16c249].type &&
      "hidden" !== _0x284c45[_0x16c249].type
    ) {
      if ("checkbox" === _0x284c45[_0x16c249].type) {
...
Live.prototype.showRoomDialogForEdit = function () {
  ...
  document.getElementById("hasSolid").checked = 0 !== _0x6d6e9f.sg;
...
Live.prototype.getFilledLimits = function () {
  ...
  for (let _0x285f68 of _0x21fa1d) {
    ...
    if (
      _0x332ddf % 2 == 1 &&
      null !== _0x7c956[_0x332ddf - 1] &&
      _0x502614 <= _0x7c956[_0x332ddf - 1]
    ) {
      return false;
    }
  }
  return _0x4467ae === _0x7c956.length ? null : _0x7c956;
};
...
Live.prototype.makeRoom = function (_0x30133c) {
  ...
  try {
    ...
    var _0x565c20 = function (_0x16ec93) {
      return (
...
Live.prototype.joinRoom = function (_0x207ea3) {
  ...
  this.toggleLobbby(false);
  this.hideResults();
  if (5 == _0x41e577 && "function" == typeof ga) {
    ga("send", {
      hitType: "event",
      eventCategory: "Team",
  ...
  switch (_0xac8d01) {
    ...
    default:
      if (_0xac8d01 >= 110 && _0xac8d01 <= 118) {
        ...
        _0x4b9bef += String.fromCharCode(65 + (31 & _0xac8d01));
        _0x29650a =
          ...
          '" class="nameIcon">';
        _0x1a01e5 = "Jstris supporter";
      } else if (999 === _0xac8d01 && _0x18f02c && _0x18f02c.icon) {
        _0x29650a =
          '<img src="' +
...
Live.prototype.getName = function (_0x41765e, _0x3d2b41) {
  var _0x51585d = undefined === _0x3d2b41 || _0x3d2b41;
  return undefined !== this.clients[_0x41765e] &&
    null !== this.clients[_0x41765e].name
    ? _0x51585d &&
      (arrayContains(this.authList, parseInt(_0x41765e)) ||
        (this.cid == parseInt(_0x41765e) && this.authorized))
      ? this.getAuthorizedNameLink(
    ...
    : -1 === _0x41765e
      ? ""
      : -2 === _0x41765e
        ? "<span style='color:#00D928'>" + i18n.newsUser + "</span>"
        : -3 === _0x41765e
          ...
          : -4 === _0x41765e
            ...
            : -5 === _0x41765e
              ...
              : i18n.noNamed + _0x41765e.toString();
};
Live.prototype.forgetRoomPlayers = function () {
  var _0xba5598 = null;
  if (undefined !== this.clients[this.cid]) {
...
Live.prototype.showMessageAboutJoin = function (
  ...
  if (
    undefined !== this.clients[_0x1ffcda] &&
    null !== this.clients[_0x1ffcda].name
  ) {
...
Live.prototype.handleResponse = function (_0x1abc4e) {
  switch (_0x1abc4e.t) {
    case 1:
      ...
      break;
    case 2:
      if (undefined === this.clients[_0x1abc4e.cid]) {
      ...
      var _0x2ba4ba =
        _0x1abc4e.hasOwnProperty("so") && true === _0x1abc4e.so;
      if (!_0x2ba4ba) {
      ...
      break;
    case 3:
      if (_0x1abc4e.cid === this.cid && 1 === _0x1abc4e.sitout) {
        if (!this.sitout) {
      ...
      if (_0x1abc4e.sitout <= 1) {
        ...
        if (
          !(this.p.gameEnded || this.currentTarget !== _0x1abc4e.cid)
        ) {
          this.changeTarget();
        }
      } else if (
      ...
      if (0 === _0x1abc4e.sitout || 2 === _0x1abc4e.sitout) {
    ...
    case 4:
      ...
      if (objSize(_0x1abc4e.players) > 0) {
        ...
        this.p.play = false;
        this.onGameEnd();
        this.LiveGameRunning = "True" == _0x1abc4e.play;
        if (
    ...
    case 6:
      ...
      if (
        ...
        if (_0x65cb6f && 0 !== _0x65cb6f.length) {
    ...
    case 8:
      ...
      if (undefined !== this.roomJoinTimes[_0x1abc4e.cid]) {
        if (
      ...
      if (this.statsSent) {
        for (
          ...
          if (
            ...
            -1 === this.notPlaying.indexOf(this.players[_0x21256b])
          ) {
    ...
    case 12:
      ...
      if (_0x1abc4e.hasOwnProperty("so") && 1 === _0x1abc4e.so) {
        this.spectatorMode(1);
    ...
    case 13:
      if (
        (this.p.pmode && 9 !== this.p.livePmode) ||
        this.p.gameEnded
      ) {
        return;
      }
    ...
    case 17:
      if (
        !(
          this.p.gameEnded ||
          this.p.pmode ||
          (this.p.Bots && 0 != this.p.Bots.mode)
        )
      ) {
    ...
    case 20:
      ...
      } else if (undefined !== this.clients[_0x1abc4e.cid]) {
...
Live.prototype.applyConfig = function (_0x1a960c) {
  ...
  if (_0x1a960c.conf.hasOwnProperty("lsnr")) {
    this.p.liveSnapRate = 100 * _0x1a960c.conf.lsnr;
  } else {
  ...
  if (3 === this.liveMode && _0x1a960c.conf.hasOwnProperty("pmode")) {
...
Live.prototype.displayLobby = function (_0x1cf30a) {
  ...
  var _0x5deddd = function (_0x4f7e32, _0x337431) {
    _0x337431 = _0x337431 || 0;
    var _0x1a8d2f = "";
    var _0x31815a = _0x4f7e32.length;
    var _0x1e9d92 = function (_0x527a72, _0x1c2d76) {
    ...
    for (var _0x16ffb7 = 0; _0x16ffb7 < _0x31815a; _0x16ffb7++) {
      ...
      if (_0x4f7e32[_0x16ffb7].mo > 0) {
        ...
        (!_0xb8aa8b || 1 === _0x4f7e32[_0x16ffb7].id.length)
      ) {
        _0x41d3de =
          '<div class="modeCol">' +
...
Live.prototype.setupLobbyHandlers = function () {
  $(".roomListSep").each(function () {
    ...
    if (null !== localStorage.getItem(_0x29ea8f)) {
      $(this).addClass("down");
      $(_0x581137).hide();
    } else {
      $(this).addClass("up");
  ...
  if (_0x11e3c8) {
    ...
    for (_0x208177 = 0; _0x208177 < _0x36eabc; _0x208177++) {
      if (_0x4770a9[_0x208177].forfeit) {
        ...
        var _0x708f6a =
          Math.round(
            (100 * _0x4770a9[_0x208177].l) /
              (_0x4770a9[_0x208177].t / 60),
          ) / 100;
        var _0x446253 =
          Math.round(
            (100 * _0x4770a9[_0x208177].a) /
              (_0x4770a9[_0x208177].t / 60),
          ) / 100;
        var _0x3a7916 =
          Math.round(
            (100 * _0x4770a9[_0x208177].p) / _0x4770a9[_0x208177].t,
          ) / 100;
        var _0x511d51 =
          Math.round(
            (100 * _0x4770a9[_0x208177].B2B) /
              (_0x4770a9[_0x208177].t / 60),
          ) / 100;
        var _0x2e3a38 = "-";
        if (
          _0x4770a9[_0x208177].hasOwnProperty("rep") &&
          0 !== _0x4770a9[_0x208177].rep
        ) {
          _0x2e3a38 =
            '<a href="/replay/live/' +
...
Live.prototype.displayTeamResults = function (_0x353e61) {
  ...
  for (
    ...
    _0x152d64.sort(function (_0x391abf, _0x194577) {
      ...
      return 0 === _0x310c9e ? _0x194577.l - _0x391abf.l : _0x310c9e;
    });
...
Live.prototype.resolveMention = function (_0x4ba798) {
  ...
  return _0x7dbdcb ? _0x300532.join(" ") : _0x4ba798.m;
};
...
Live.prototype.getChatLineClassesFor = function (_0x52f2b4) {
  return -5 === _0x52f2b4 ? ["infoChl"] : null;
};
Live.prototype.showInChat = function (
  ...
  if (null != _0x5e78da) {
    ...
    } else if ("string" == typeof _0x5e78da) {
...
Live.prototype.showInLobbyChat = function (_0x1771e1) {
  ...
  if (_0x1771e1.hasOwnProperty("n")) {
    if (_0x1771e1.hasOwnProperty("d") && 1 === _0x1771e1.d) {
      _0x465792 =
...
Live.prototype.onMessage = function (_0x28e26d) {
  if ("string" == typeof _0x28e26d.data) {
    if ("9002" === this.port) {
    ...
    if (1 === _0x53bbb7[0]) {
      ...
      for (_0x3f33e0 = 3; _0x3f33e0 < _0x5e100c; _0x3f33e0++) {
        ...
        _0x2f41dc.push(15 & _0x515c64);
        _0x2f41dc.push((240 & _0x515c64) >> 4);
        if (10 === _0x2f41dc.length) {
    ...
    } else if (4 === _0x53bbb7[0]) {
      this.decodeActionsAndPlay(_0x53bbb7, true);
    } else if (5 === _0x53bbb7[0]) {
      this.decodeActionsAndPlay(_0x53bbb7, false);
    } else if (6 === _0x53bbb7[0] || 7 === _0x53bbb7[0]) {
      this.decodeReplay2Fragment(_0x53bbb7);
    } else if (99 === _0x53bbb7[0]) {
      return void this.safeSend(_0x28e26d.data);
    }
  }
};
Live.prototype.decodeActionsAndPlay = function (
  ...
  if (this.p.GS.extendedAvailable) {
    ...
    for (_0x1b0ac8.byte = 2; ; ) {
      ...
      if (null === _0x4566ee.t || null === _0x4566ee.a) {
        break;
      }
...
Live.prototype.onClose = function (_0x358718) {
  ...
  if (4001 === _0x358718.code) {
    ...
    return void (this.p.connectStatusElement.innerHTML +=
      " | " + _0x358718.reason);
  }
  if (4002 !== _0x358718.code) {
    if (4003 === _0x358718.code || 4004 === _0x358718.code) {
      ...
      return void (4003 === _0x358718.code
    ...
    if (4005 !== _0x358718.code) {
      if (4006 === _0x358718.code) {
        this.chatMajorWarning(
          "OLD VERSION - refresh to update your client!",
          "criticalErr",
        );
      } else {
        if (4007 === _0x358718.code || 4008 === _0x358718.code) {
          this.p.Caption.loading("Switching servers");
          this.conAttempts = 0;
          if (4008 === _0x358718.code) {
          ...
          this.updateConnectionInfo();
          return void setTimeout(this.changeServer.bind(this), 50);
        }
        if (1006 === _0x358718.code && this.joinRemote) {
...
Live.prototype.changeServer = function () {
  ...
  this.socket.onopen = function (_0x40aa8b) {
    if (1 === _0x40aa8b.target.readyState) {
      _0x2761cb.onOpen(_0x40aa8b);
    }
  };
  this.socket.onmessage = this.onMessage.bind(this);
  var _0x115412 = function (_0xbf89a6) {
  ...
  this.socket.onerror = function (_0x3144b7) {
    ...
    if (
      !(
        0 !== _0x3144b7.target.readyState &&
        1 !== _0x3144b7.target.readyState
      )
    ) {
...
Live.prototype.connect = function () {
  ...
  if (!_0x4d8596) {
    ...
    if (_0x58a208 && 36 == _0x58a208.length) {
    ...
    if (_0x5db6d5 && 36 == _0x5db6d5.length) {
    ...
    if (_0x59f18a && 36 == _0x59f18a.length) {
  ...
  var _0x4bd763 =
    ...
    isNaN((_0x34ec44 = parseInt(this.p.Settings.getCookie("nick"))))
      ...
      : "&nt=" + _0x34ec44;
  var _0x520ba5 =
    null !== this.p.Settings.getBanArtifact()
...
Live.prototype.sendRepFragment = function (_0x5d07ed, _0x469582) {
  ...
  for (var _0x33ebce = 0; _0x33ebce < _0x15383e; _0x33ebce++) {
    ...
    if (_0x469582) {
      ...
      _0x517556.pushBits(63 & _0x4a7f94, 6);
    }
    _0x517556.pushBits(_0x5d07ed[_0x33ebce].a, 4);
    if (undefined !== _0x7c82d0.AuxBits[_0x5d07ed[_0x33ebce].a]) {
  ...
  if (true === this.connected && !this.p.isPmode(true)) {
    ...
    for (var _0x54cf90 = 0; _0x54cf90 < 20; _0x54cf90++) {
      for (var _0x4d80bf = 0; _0x4d80bf < 10; _0x4d80bf++) {
        _0x3e675c |=
          (15 & _0x4f8416[_0x54cf90][_0x4d80bf]) << (4 * _0x1ed095++);
        if (2 == _0x1ed095) {
...
Live.prototype.sendRestartEvent = function () {
  if (this.p.Bots && 1 == this.p.Bots.mode) {
    this.p.Bots.newGame();
  } else {
    this.safeSend('{"t":5}');
    this.p.focusState = 0;
...
Live.prototype.beforeReset = function () {
  if (!this.p.isTabFocused) {
    ...
    var _0x3527fe = setInterval(function () {
      ...
      if (101 === _0x34fb79 || _0x4ba538.isTabFocused) {
...
Live.prototype.changeTarget = function () {
  ...
  for (var _0x2fc5b5 = 0; _0x2fc5b5 < this.bots.length; _0x2fc5b5++) {
    if (
      false === arrayContains(this.notPlaying, this.bots[_0x2fc5b5])
    ) {
  ...
  for (_0x2fc5b5 = 0; _0x2fc5b5 < _0x4b144d; _0x2fc5b5++) {
    if (
      ...
      false === arrayContains(this.bots, this.players[_0x2fc5b5])
    ) {
  ...
  if (_0x3e7528.length > 0) {
    ...
    _0x205261 =
      undefined !== _0x3e7528[_0x3ae13f + 1]
...
Live.prototype.sendAttack = function (
  ...
  if (0 !== this.gdm || 0 !== this.currentTarget) {
    ...
    _0x4d0985[5] = (65280 & this.gid) >> 8;
    _0x4d0985[6] = (255 & this.gid) >> 0;
    if (0 === this.gdm) {
      _0x4d0985[7] = (-16777216 & _0x3e1036) >> 24;
      _0x4d0985[8] = (16711680 & _0x3e1036) >> 16;
      _0x4d0985[9] = (65280 & _0x3e1036) >> 8;
      _0x4d0985[10] = (255 & _0x3e1036) >> 0;
    }
...
Live.prototype.setResetButton = function (_0x212b19) {
  if (this.hostStartMode || (this.p.Bots && 1 == this.p.Bots.mode)) {
...
Live.prototype.replayInfoToChat = function (
  ...
  if (this.authorized) {
    var _0x9b9fc0 =
      ...
      "&display=4&id=" +
      _0x2988d5;
    var _0x2fb02b = 5 === _0x46ea7e ? "my scores" : "my times";
    if (7 === _0x46ea7e) {
...
Live.prototype.sendGameModeResult = function (_0x3b692c) {
  if (-1 !== _0x3b692c.mode) {
    ...
    var _0x4a93c9 = "";
    if (
      0 === _0x3b692c.config.r &&
      1 === this.p.pmode &&
      ((1 === this.p.sprintMode &&
        20 === this.p.gamedata.TSD &&
        40 === this.p.gamedata.lines) ||
        (2 === this.p.sprintMode &&
          10 === this.p.gamedata.TSD &&
          20 === this.p.gamedata.lines))
    ) {
      _0x3b692c.config.m = 458753;
      this.p.pmode = 7;
      this.p.sprintMode = 1;
      if (20 === this.p.gamedata.TSD) {
        this.p.gamedata.TSD20 = Math.round(1000 * _0x1738bd);
      }
    ...
    if (1 === this.p.pmode) {
      ...
      8 === this.p.pmode &&
      (_0x4f30bb && (_0x4f30bb = "?" + _0x4f30bb.substr(1)),
...
Live.prototype.sendChat = function (_0x4c6dcd) {
  ...
  if (_0x116ad9.length > 0) {
    ...
    } else if ("/cid" === _0x116ad9.substring(0, 4)) {
      this.showInChat(
        "",
        this.p.GS.slots[parseInt(_0x116ad9.split(" ")[1])].cid,
      );
    } else if ("/ping" === _0x116ad9) {
      _0x4c6dcd = '{"t":99}';
      this.pingSent = this.p.timestamp();
      this.safeSend(_0x4c6dcd);
    } else if ("/dc" === _0x116ad9) {
      this.socket.close();
    } else if ("/clients" === _0x116ad9) {
      for (var _0x3b906 in this.clients)
        this.showInChat(_0x3b906, this.clients[_0x3b906].name);
    } else if ("/memory" === _0x116ad9) {
      if (window.performance && window.performance.memory) {
        this.showInChat(
          "Memory",
          Math.round(
            (1000 * window.performance.memory.usedJSHeapSize) /
              1048576,
          ) /
            1000 +
            " MiB",
    ...
    } else if ("/xbuffer" === _0x116ad9.substring(0, 8)) {
...
Live.prototype.getParameterByName = function (_0x357366) {
  ...
  return null === _0x55374e
    ? ""
    : decodeURIComponent(_0x55374e[1].replace(/\+/g, " "));
};
Live.prototype.showClass = function (_0x4e004f, _0x1c39e5) {
  _0x1c39e5 = undefined === _0x1c39e5 || _0x1c39e5;
...
RoomInfo.prototype.displayRoomDetail = function (_0x4694fb) {
  if (
    ...
    "none" !== this.roomDetailBox.style.display
  ) {
...
RoomInfo.prototype.displayConfig = function (_0x25dafa) {
  ...
  for (let _0x34657b in _0x25dafa.s) {
    ...
    let _0x33a8f1 = "object" == typeof this.CONF_NAMES[_0x34657b];
    let _0x62ce0c = "";
    let _0x47f13e =
      "• " +
      (_0x33a8f1
    ...
    if ("boolean" == typeof _0x25dafa.s[_0x34657b]) {
...
RoomInfo.prototype.displayPlayers = function (_0x35c774) {
  ...
  _0x35c774.p.p.sort(function (_0x5ab2f7, _0x3314dd) {
    return _0x5ab2f7.type && !_0x3314dd.type
      ? -1
      : !_0x5ab2f7.type && _0x3314dd.type
        ? 1
        : _0x5ab2f7.type &&
            _0x3314dd.type &&
          ...
          ? _0x5ab2f7.ti > _0x3314dd.ti
            ? -1
            : 1
          : _0x5ab2f7.n.localeCompare(_0x3314dd.n);
  });
  var _0x4d5a24 = "";
  var _0x23ab2f = null;
  for (var _0x4b143a of _0x35c774.p.p) {
    if (null !== _0x23ab2f && _0x23ab2f === _0x4b143a.n) {
      continue;
    }
...
Settings.prototype.reloadCanvases = function () {
  var _0x88a784 = function (_0x41a180) {
...
Settings.prototype.closeSettings = function () {
  ...
  var _0x567325 = Math.round(100 * createjs.Sound.volume);
  ...
  if (
    ...
    !(
      document.getElementById("wGL").checked || "2d" === this.p.v.NAME
    )
  ) {
    this.startCtx2D();
  }
...
Settings.prototype.onStatGameModeChange = function (_0xc81bcf) {
  _0xc81bcf = undefined === _0xc81bcf ? 0 : _0xc81bcf.target.value;
  for (
    var _0x1f6686 = 1;
...
Settings.prototype.resetSettings = function () {
  let _0x344928 =
    null !== localStorage.getItem(self.BAN_ARTIFACT_KEY);
  localStorage.clear();
  this.applyDefaults();
  this.openSettings();
  if (_0x344928) {
...
Settings.prototype.loadFromJson = function (_0x161910) {
  ...
  if (
    ...
    this.startWebGL();
  } else if (!(_0x161910.wGL || "2d" === this.p.v.NAME)) {
    this.startCtx2D();
  }
};
...
Settings.prototype.tryToLoadControlsFromCookie = function () {
  ...
  this.rescaleNow = !(null === _0x1856ca || "0" === _0x1856ca);
  this.setGrid(1);
};
Settings.prototype.sendSettings = function () {
  ...
  for (_0x151053 = 0; _0x151053 < _0x3aa750.length; ++_0x151053) {
    if (
      "input" !== _0x3aa750[_0x151053].id.substr(0, 5) &&
      "ffRestart" !== _0x3aa750[_0x151053].id &&
      "stat" !== _0x3aa750[_0x151053].id.substr(0, 4) &&
      "gameStartNotif" !== _0x3aa750[_0x151053].id
    ) {
      if ("radio" === _0x3aa750[_0x151053].type) {
        if (_0x3aa750[_0x151053].checked) {
          ...
          if ("bSk" == _0x5e391d && _0x3aa750[_0x151053].dataset.p) {
            _0x31ed7c.bSp = _0x3aa750[_0x151053].dataset.p;
          }
        }
      } else if ("checkbox" === _0x3aa750[_0x151053].type) {
        _0x31ed7c[
          ("cancelDAS" === _0x3aa750[_0x151053].id ? "DASca" : null)
            ? "cancelDAS" === _0x3aa750[_0x151053].id
              ? "DASca"
              : null
...
Settings.prototype.nullpoDAS = function () {
  ...
  if (!isNaN(_0x41cebb) && _0x41cebb >= 0 && _0x41cebb <= 1000) {
    var _0x1c1385 = Math.round(16.666666666666668 * _0x41cebb);
    if (
      true ===
      confirm(
...
Settings.prototype.setupSwipeControl = function () {
  ...
  this.mc.on("panleft", function (_0x3d82f6) {
    if (
      ...
      Math.abs(_0x3d82f6.deltaX) > 4 * _0x5a15d0 &&
  ...
  this.mc.on("panright", function (_0x46d52b) {
    if (
      ...
      Math.abs(_0x46d52b.deltaX) > 4 * _0x5a15d0 &&
      _0x240c55.moveBlockToTheWall(1)
    ) {
      _0x240c55.Replay.add(
        new ReplayAction(
...
Settings.prototype.getKeyName = function (_0x1499af) {
  ...
  return undefined !== _0x1c92ea[_0x1499af]
    ? _0x1c92ea[_0x1499af]
    : "KeyCode " + _0x1499af;
};
...
GameSlots.prototype.fullScreen = function (_0x5bbbed) {
  ...
  if (_0x5bbbed) {
    ...
    this.w = this.gsDiv.offsetWidth;
    this.h = Math.min(this.w / 2, 1.05 * _0xaef594.offsetHeight);
...
GameSlots.prototype.shrink = function () {
  ...
  for (
    ...
    if (-1 === this.slots[_0x1c586c].cid) {
      for (
        var _0xc0643c = _0x1c586c + 1;
        _0xc0643c < this.slots.length &&
        -1 === this.slots[_0xc0643c].cid;
      ) {
        _0xc0643c++;
      }
  ...
  if (2 === this.p.Live.liveMode) {
    ...
    for (
      ...
      for (
        ...
        -1 !== this.slots[_0x44d3b1].cid &&
        -1 !== this.slots[_0x44d3b1 + 1].cid;
        _0x44d3b1++
      ) {
        if (
...
GameSlots.prototype.initTeamTag = function (
  ...
  var _0x13e822 = null;
  if (undefined !== this.teamTags[_0x27c41b]) {
...
GameSlots.prototype.tsetup = function (_0x42604c) {
  ...
  this.nameHeight = 18;
  var _0x424a50 =
    1 === (_0x580a9a = _0x3f2b8e)
      ? 0
      : (2 === _0x580a9a ? 30 : 60) / (_0x580a9a - 1);
  ...
  if (_0x19fbe2 > this.w) {
    ...
    this.slotHeight = this.nmob(
      2 * (this.slotWidth - this.redBarWidth),
    );
    this.redBarWidth = Math.ceil(this.slotHeight / 55) + 1;
    this.slotWidth = this.slotHeight / 2 + this.redBarWidth;
    _0x19fbe2 =
...
GameSlots.prototype.setup = function (_0x370820, _0x537178) {
  if (undefined === _0x537178) {
    _0x537178 = false;
  }
  ...
  var _0x566083 = 2 === _0x58799e ? 30 : 60;
  this.isExtended =
    this.extendedAvailable &&
    (this.forceExtended ||
      -1 !== this.extendedView.indexOf(_0x370820));
  if (this.isExtended) {
    if (1 === this.rowCount) {
      _0x566083 = 30;
    } else if (2 === this.rowCount) {
      var _0x35594a = [0, 0, 90, 65];
      _0x566083 =
        _0x58799e < _0x35594a.length ? _0x35594a[_0x58799e] : 60;
    }
  }
  var _0x46aada = 1 === this.rowCount ? 0 : 10;
  var _0x18d773 = 1 === _0x58799e ? 0 : _0x566083 / (_0x58799e - 1);
  ...
  this.nameFontSize = Math.ceil(
    this.nameFontSize * Math.max(1, 0.8 * this.zoom),
  );
  this.nameHeight = Math.ceil(
    this.nameHeight * Math.max(1, 0.8 * this.zoom),
  );
  _0x18d773 *= this.zoom;
  ...
  if (_0xfae97b > this.w) {
    ...
    this.matrixWidth = this.isExtended
      ...
      : this.slotWidth;
    this.matrixHeight = this.nmob(
      2 * (this.matrixWidth - this.redBarWidth),
    );
    this.redBarWidth = Math.ceil(this.matrixHeight / 55) + 1;
    this.matrixWidth = this.matrixHeight / 2 + this.redBarWidth;
    this.slotWidth = this.isExtended
...
GameSlots.prototype.getSlot = function (_0x477d01, _0x2347c9) {
  var _0x2035dd;
  if (
    null !== (undefined === _0x2347c9 ? null : _0x2347c9) &&
    -1 === this.teamMembers[_0x2347c9].indexOf(_0x477d01)
  ) {
    this.teamMembers[_0x2347c9].push(_0x477d01);
  }
  for (_0x2035dd = 0; _0x2035dd < this.slots.length; _0x2035dd++) {
    if (-1 === this.slots[_0x2035dd].cid) {
...
Slot.prototype.init = function () {
  ...
  var _0x3c44b1 = 0.8 * this.gs.holdQueueBlockSize;
  var _0x14e477 = 4 * this.gs.holdQueueBlockSize + _0x3c44b1;
  ...
  if (this.gs.slotStats && this.gs.matrixWidth >= 50) {
    ...
    let _0x1e8a73 =
      1.1 * this.stats.statsDiv.childNodes[0].clientWidth;
    let _0x21275a =
      2 * _0x1e8a73 < 0.85 * this.gs.matrixWidth ||
      _0x1e8a73 > 0.6 * this.gs.matrixWidth;
...
SlotStats.prototype.init = function () {
  ...
  let _0x4c8d03 = 2 * this.gs.redBarWidth;
...
SlotView.prototype.changeSkin = function (_0x212d72, _0x1a99bb) {
  if (7 === _0x212d72 && undefined !== _0x1a99bb) {
  ...
  if (
    _0x212d72 < 1000 &&
    (undefined === this.g.skins[_0x212d72] ||
...
SlotView.prototype.drawBgGrid = function () {
  ...
  for (_0xaa15fe = 0; _0xaa15fe < 9; _0xaa15fe++) {
    for (var _0x4e493a = 1; _0x4e493a < 20; _0x4e493a++) {
      this.bgctx.moveTo(
        _0xaa15fe * this.block_size + 0.75 * this.block_size,
        _0x4e493a * this.block_size + 0.5,
      );
      this.bgctx.lineTo(
        (_0xaa15fe + 1) * this.block_size + 0.2 * this.block_size,
        _0x4e493a * this.block_size + 0.5,
      );
    }
  }
...
SlotView.prototype.updateTextBar = function () {
  if (this.slot.gs.slotStats) {
    ...
    var _0x4875de =
      Math.round((100 * this.g.placedBlocks) / (_0x29b597 / 1000)) /
      100;
    var _0x43afc9 =
      Math.round(
        (100 * this.g.gamedata.linesSent) / (_0x29b597 / 60000),
      ) / 100;
...
SlotView.prototype.printTextBg = function () {
  ...
  this.ctx.beginPath();
  var _0x507483 =
    1 === this.slot.gs.shownSlots
      ? 0.35 * this.slot.gs.matrixHeight
      : 0.65 * this.slot.gs.matrixHeight;
  this.ctx.rect(
    0,
...
SlotView.prototype.printSlotPlace = function (_0x5ec819) {
  ...
  var _0x1bbb9a =
    1 === this.slot.gs.shownSlots
      ? 0.47 * this.slot.gs.matrixHeight
      : 0.77 * this.slot.gs.matrixHeight;
  this.ctx.fillText(
    _0x108905.str,
...
SlotView.prototype.printSlotNotPlaying = function () {
  ...
  var _0x4a13ac =
    1 === this.slot.gs.shownSlots
      ? 0.475 * this.slot.gs.matrixHeight
      : 0.77 * this.slot.gs.matrixHeight;
  this.ctx.fillText(
    i18n.notPlaying,
    Math.round(this.slot.gs.matrixWidth / 2),
...
StatsManager.prototype.resetAll = function () {
  for (var _0x11bfe5 in this.stats) this.stats[_0x11bfe5].reset();
  this.dirty = true;
};
...
GameCaption.prototype.outOfFocus = function (_0x1ad90d) {
  if (
    ...
    "block" === this.captions[this.GAME_PLACE].style.display
  ) {
    return;
  }
  if (this.OUT_OF_FOCUS in this.captions) {
    return void (this.captions[this.OUT_OF_FOCUS].style.display =
      "block");
  }
...
GameCaption.prototype.readyGo = function (_0x1eba28) {
  ...
  _0x1fd887.textContent = 0 === _0x1eba28 ? i18n.ready : i18n.go;
...
GameCaption.prototype._fadeOut = function (
  ...
  if (undefined === _0x5dda65) {
    _0x5dda65 = null;
  }
  if (undefined === _0x53aa38) {
    _0x53aa38 = 1;
  }
...
GameCaption.prototype.liveRaceFinished = function () {
  if (this.RACE_FINISHED in this.captions) {
    ...
    return void this._fadeOut(
      this.captions[this.RACE_FINISHED],
      5000,
      3,
      0.85,
    );
...
Mobile.prototype.isMobile = function () {
  ...
  return null !== _0x47d498
    ? "false" !== _0x47d498 && _0x47d498
    : this.isMobileDetect();
};
  ...
  $("#res").on(
    ...
    function () {
      if (
        !(
          this.p.Bots ||
          (!this.p.Live.sitout && 0 !== this.p.Live.players.length)
        )
      ) {
...
Mobile.prototype.setupButtonDragDrop = function () {
  ...
  function _0x2edc25(_0x107baf) {
    ...
    if (
      "touchstart" === _0x107baf.type &&
      2 === _0x107baf.touches.length
    ) {
      ...
      if (_0x31f791) {
        ...
        return void (_0x5d1834 = false);
      }
    }
    if (-1 === _0x19ad35.indexOf(_0x107baf.target)) {
      return;
    }
  ...
  function _0x2e11b8(_0x67da41) {
    if (_0x302062.draggingEnabled) {
      if (
        _0x30d2d8 &&
        "touchmove" === _0x67da41.type &&
        2 === _0x67da41.touches.length
      ) {
        ...
        if (_0x2abaf7) {
          ...
          _0x157398 = (5 * Math.round(_0x25924d / 5)) / _0x143858;
          _0x273391 = (5 * Math.round(_0x59d87a / 5)) / _0x2d2c3a;
          _0x538bff =
        ...
        return void _0x14881e(_0x30d2d8);
      }
      var _0x1f0572;
      var _0x442fbe;
      var _0x143858;
      ...
      if (_0x5d1834) {
        ...
        if (_0x2abaf7) {
          ...
          var _0x553c83 = (function (
            ...
            var _0x28fc7d = 5 * Math.round(_0x34dbf8 / 5);
            var _0x18081b = 5 * Math.round(_0x3d2552 / 5);
            return {
  ...
  _0x19ad35.forEach((_0x519384) => {
    ...
    _0x519384.custom_scale =
      null !== _0x658c59 ? parseFloat(_0x658c59) : 1;
    _0x14881e(_0x519384);
  });
...
Replay.prototype.getBlobData = function () {
  ...
  for (var _0x195e07 = 0; _0x195e07 < _0x16f61d; _0x195e07++) {
    if (null !== _0x2fa927 && _0x2fa927 > this.actions[_0x195e07].t) {
    ...
    if (undefined !== this.AuxBits[this.actions[_0x195e07].a]) {
...
Replay.prototype.getGameTime = function (_0x531f25) {
  if (undefined === _0x531f25) {
    _0x531f25 = true;
  }
  var _0x32f344 = this.actions[this.actions.length - 1].t;
  if (!_0x531f25) {
    if (undefined !== this.config.afk) {
...
Replay.prototype.postData = function (_0x532b93, _0x3fb36e) {
  ...
  _0x4b5b11.onload = function () {
    if (200 === _0x4b5b11.status) {
      if ("function" == typeof _0x424a77.onSaved) {
...
RulesetManager.prototype.fullModeName = function (
  ...
  var _0xd3651e =
    0 === _0x439e57 ? "" : this.RULESETS[_0x439e57].name;
  var _0xa2f7b2 = "";
  var _0x173b17 = "";
  _0x5ba74e %= 10;
...
RulesetManager.prototype.adjustToValidMode = function (
  ...
  for (const _0x2cac64 of this.MODES) {
    ...
    for (const _0x92b86f of _0x2cac64.modes) {
      let _0x153a4f = -1 !== _0x92b86f.rs.indexOf(this.pmodeRuleId);
      if (
    ...
    if (_0x2cac64.id === _0x5ad518 && _0x2d324a) {
      return void (this.p.sprintMode = _0x5a6228);
    }
  }
...
RulesetManager.prototype.updateModeMenu = function () {
  ...
  for (const _0x4a4e17 of this.MODES) {
    ...
    for (const _0x496396 of _0x5cbaab)
      if (-1 !== _0x496396.rs.indexOf(_0x253c04)) {
...
Items.prototype.genItem = function () {
  ...
  if (this.avail()) {
    return 0 === _0x403da6 || this.fs
      ? ((this.fs = false), this.p.random(1, 4))
      : 0;
  }
};
...
Items.prototype.applyItem = function (_0x2f2531, _0x3bb0ec) {
  ...
  } else if (10 === _0x2f2531) {
    this.p.Caption.loading("Instant win", 2);
  } else if (11 === _0x2f2531) {
...
Items.prototype.invertMatrix = function () {
  ...
  for (var _0x6c1e38 = 0; _0x6c1e38 < 2; _0x6c1e38++) {
    if (9 !== this.p.matrix[_0x6c1e38][0]) {
...
Items.prototype.loadFourWide = function (_0x2faabf) {
  ...
  for (
    ...
    if (9 !== this.p.matrix[_0x371589][0]) {
...
Items.prototype.compressMatrix = function (_0x1a1a13) {
  ...
  for (var _0x1b5a3f = 1; _0x1b5a3f <= _0x1a1a13; _0x1b5a3f++) {
    for (var _0x12e86b = 0; _0x12e86b < 20; ++_0x12e86b) {
      if (9 !== this.p.matrix[_0x12e86b][0]) {
...
Items.prototype.revert = function (_0x20afaf) {
  ...
  } else if (11 === _0x20afaf) {
    this.changeRandomizer(this.p.R.rnd, false);
  } else if (12 === _0x20afaf) {
    this.changeBBS(this.origBBS);
  }
};
...
Friends.prototype.connect = function (_0x4439b7, _0x2cb299) {
  ...
  this.connectionTimeout = setTimeout(function () {
    ...
    if (null !== _0x342b57 && 0 === _0x342b57.readyState) {
...
Friends.prototype.reconnect = function () {
  this.reconnects++;
  let _0x1e055e = Math.min(5000, 1000 * (this.reconnects - 1));
...
Friends.prototype.onMessage = function (_0x40f36b) {
  if ("string" == typeof _0x40f36b.data) {
  ...
  switch (_0xeb1fbf.t) {
    ...
    case 5:
      ...
      if (this.friendsOpened) {
        ...
        } else if (null !== this.openChatName) {
          this.notifSoundDM();
...
Friends.prototype.checkNewFriend = function (_0x9c582d) {
  if (!Array.isArray(this.friends) || 0 === this.friends.length) {
    return void this.requestRefresh();
  }
  let _0x148f6f = false;
  let _0x2a213c = false;
  for (
...
Friends.prototype.tryRenderInvite = function (
  ...
  if (_0x1a5327) {
    ...
    var _0x33f1d4 = new Date(1000 * _0x1c0fee);
    let _0x2f22e9 =
      _0x33f1d4.getHours() +
      ":" +
...
Friends.prototype.showInChat = function (
  ...
  if ("object" == typeof _0x3011bf && null !== _0x3011bf) {
...
Friends.prototype.updateFriendList = function () {
  ...
  this.friends.sort(function (_0x1b7118, _0x1863ed) {
    return _0x1b7118.s != _0x1863ed.s
      ? _0x1b7118.s && !_0x1863ed.s
        ? -1
        : 1
      : _0x1b7118.c && !_0x1863ed.c
        ? -1
        : _0x1863ed.c && !_0x1b7118.c
          ? 1
          : _0x1b7118.n.localeCompare(_0x1863ed.n);
  });
  let _0x580f05 = null;
  for (
    let _0x393eb1 = 0;
...
Friends.prototype.decideFriendsBoxMode = function () {
  if (this.viewIntro()) {
    ...
    } else if (0 === this.friendsCount) {
      this.friendBoxMode(this.VIEW_MODE.NO_FRIENDS);
    } else if (null === this.friendsCount || null === this.friends) {
...
(function () {
  window.onload = function () {
    ...
    var _0x326e40 = function () {
      try {
        if (
          createjs.WebAudioPlugin.context &&
          "suspended" === createjs.WebAudioPlugin.context.state
        ) {
  ...
  function _0x56bd39(_0x2277d4, _0x289339) {
    _0x289339 = _0x289339 || {};
    if ("webGL" === _0x185322.v.NAME) {
      if ("gif" !== _0x2277d4.split(".").pop()) {
...
ChatAutocomplete.prototype.init = function () {
  ...
  this.inp.addEventListener(
    "keydown",
    function (_0x5c58e1) {
      if ("none" !== _0x4a6040.hintsElem.style.display) {
        if (38 === _0x5c58e1.keyCode || 40 === _0x5c58e1.keyCode) {
          _0x4a6040.moveSelected(38 === _0x5c58e1.keyCode ? -1 : 1);
          _0x5c58e1.preventDefault();
        } else if (
          13 === _0x5c58e1.keyCode &&
...
ChatAutocomplete.prototype.processHint = function (_0x5d44bb) {
  ...
  if (
    ...
    var _0x1100b7 = 0;
    var _0xda11b5 =
      "function" == typeof this.hints ? this.hints() : this.hints;
    ...
    for (var _0x139ff5 of _0x2a9bbe) {
      ...
      _0xa1b12f.addEventListener(
        ...
        function (_0x3ded09) {
          ...
          for (var _0xcb5a75 = _0x14b2a8 + 1; -1 !== _0x14b2a8; ) {
            if (
              -1 !==
...
(function (_0x31cf5d) {
  ...
  function _0x14b432(_0xe50b43, _0x57554e) {
    ...
    var _0x2b1bbf;
    var _0xb41b2e;
    _0x2377c1 = 3 & _0xe50b43.length;
    _0x2373d7 = _0xe50b43.length - _0x2377c1;
    _0x5b9482 = _0x57554e;
    for (_0xb41b2e = 0; _0xb41b2e < _0x2373d7; ) {
      _0x2b1bbf =
        (255 & _0xe50b43.charCodeAt(_0xb41b2e)) |
        ((255 & _0xe50b43.charCodeAt(++_0xb41b2e)) << 8) |
        ((255 & _0xe50b43.charCodeAt(++_0xb41b2e)) << 16) |
        ((255 & _0xe50b43.charCodeAt(++_0xb41b2e)) << 24);
      ++_0xb41b2e;
      _0x5b9482 =
        27492 +
        (65535 &
                ...
                (_0x5b9482 =
                  ((_0x5b9482 ^= _0x2b1bbf =
                    ((65535 &
                      (_0x2b1bbf =
                        ((_0x2b1bbf =
                          ((65535 & _0x2b1bbf) * 3432918353 +
                            ((((_0x2b1bbf >>> 16) * 3432918353) &
                              65535) <<
                              16)) &
                          4294967295) <<
                          15) |
                        (_0x2b1bbf >>> 17))) *
                      461845907 +
                      ((((_0x2b1bbf >>> 16) * 461845907) & 65535) <<
                        16)) &
                    4294967295) <<
                    13) |
                  (_0x5b9482 >>> 19))) +
              (((5 * (_0x5b9482 >>> 16)) & 65535) << 16)) &
            4294967295)) +
    ...
    switch (_0x2377c1) {
      case 3:
        _0x2b1bbf ^=
          (255 & _0xe50b43.charCodeAt(_0xb41b2e + 2)) << 16;
      case 2:
        _0x2b1bbf ^= (255 & _0xe50b43.charCodeAt(_0xb41b2e + 1)) << 8;
      case 1:
        _0x5b9482 ^= _0x2b1bbf =
          ((65535 &
            (_0x2b1bbf =
    ...
    _0x5b9482 =
      (2246822507 * (65535 & (_0x5b9482 ^= _0x5b9482 >>> 16)) +
        (((2246822507 * (_0x5b9482 >>> 16)) & 65535) << 16)) &
      4294967295;
    _0x5b9482 =
      (3266489909 * (65535 & (_0x5b9482 ^= _0x5b9482 >>> 13)) +
        (((3266489909 * (_0x5b9482 >>> 16)) & 65535) << 16)) &
      4294967295;
    return (_0x5b9482 ^= _0x5b9482 >>> 16) >>> 0;
  }
  var _0x454209 = function () {
  ...
  _0x454209.prototype = {
    get: function () {
      ...
      function _0x25eaff(_0x4aed10, _0x2949c4) {
        try {
          ...
          return null != _0x2dc186 ? _0x2dc186 : _0x2949c4 || "";
        } catch (_0xb652df) {
          return _0x2949c4 || "";
        }
      }
      ...
      var _0xc39eba =
        null != _0x28436e.hardwareConcurrency
          ? String(_0x28436e.hardwareConcurrency)
          : "";
      var _0x30ef4b =
        null != _0x28436e.maxTouchPoints
    ...
    gtz: function () {
      ...
      var _0xee4e2a;
      _0x24adcb = new Date();
      return (_0xee4e2a = String(
        -_0x24adcb.getTimezoneOffset() / 60,
      )) < 0
        ? "-" + ("0" + (_0xee4e2a *= -1)).slice(-2)
        : "+" + ("0" + _0xee4e2a).slice(-2);
    },
    gla: function () {
    ...
    webgl2: function () {
      ...
      let _0x4753fc = "";
      try {
        var _0x2ede9e = function (_0x67c18a) {
...
EmoteSelect.prototype.createGroups = async function (_0x3817ba) {
  ...
  _0x3817ba.forEach((_0x401705) => {
    ...
    let _0x1e80e8 = 45 * Math.ceil(_0x515502.length / 6) + 35.4;
...
EmoteSelect.prototype.getCaretPosition = function () {
  return this.input.selectionStart || "0" == this.input.selectionStart
